var dnsbl_list = require('./list/dnsbl_list.json'), //source: http://multirbl.valli.org/list/
  dnsbl_v6_list = require('./list/dnsbl_v6_list.json'), //source: http://multirbl.valli.org/list/
  uribl_list = require('./list/uribl_list.json'), //source: http://multirbl.valli.org/list/
  LIMIT = 200,
  async = require('async'), 
  dns = require('dns'),
  util = require('util'),
